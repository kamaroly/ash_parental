defmodule AshParentalTest do
  ...
  defmodule Comment do
    ...
    ash_parental do
      # <-- Enable distroy with children option
  ...
  defmodule Domain do
    ...
    resources do
      resource(AshParentalTest.Comment)
      resource(AshParentalTest.Category)
    end
  end
